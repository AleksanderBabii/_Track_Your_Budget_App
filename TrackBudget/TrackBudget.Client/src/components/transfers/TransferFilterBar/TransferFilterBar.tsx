...
export function TransferFilterBar({
    ...
    const updatedFilters = <T extends keyof TransferFilters>(key: T, value: TransferFilters[T]) => {
        onFiltersChange({
            ...filters,
            [key]: value,
        });
        ...
        <div className={styles.filterBar}>
            <div className={styles.filterRow}>
                ...
                <Select
                    ...
                    onChange={(e) => updatedFilters("sortBy", e.target.value as TransferFilters["sortBy"])}
                >
                ...
                <Input
                    ...
                    onChange={(e) => updatedFilters("startDate", parseDateInputValue(e.target.value))}
                />
                ...
                <Input
                    ...
                    onChange={(e) => updatedFilters("endDate", parseDateInputValue(e.target.value))}
                />
            </div>
